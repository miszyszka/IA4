...
| 2026-09-25 13:35 | `(uzupełnić)` | `Project.gs`, `IA4_INSTRUKCJA.md` | Wersja 0.21: naprawa `DECISIONS` w `Project.gs` — D4–D6 pokazywały w arkuszu PROJEKT nieaktualny status sprzed 0.7, mimo że w instrukcji są ✅ od dawna. L12 rozszerzone. |
