...
| 2026-09-26 15:00 | `35d519c` | `IA4_INSTRUKCJA.md`, `Project.gs` (STAGES Etapu 1, DECISIONS D8–D21), `S1_KATALOG_BAZOWY.md`, `telemetry/README.md` + wersje | Wersja 0.25: szczegółowy plan Etapu 1 — 286 sygnałów w 8 kategoriach, wspólne definicje wskaźników, arkusz S1, silnik i kryteria; D19–D21 do potwierdzenia; L24, L25. |
