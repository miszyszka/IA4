...
| 2026-09-26 13:10 | `(uzupełnić)` | `Code.gs`, `Project.gs`, `IA4_INSTRUKCJA.md` + wersje | Wersja 0.24: naprawa regresji z 0.23 (L23) — `projComputeGaps_`/`projRender_` z `applyManual: false` dla wywołań w tle, żeby nie kasować świeżych auto-akceptacji migawką arkusza sprzed renderu. |
