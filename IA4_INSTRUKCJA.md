...
| 2026-09-26 12:15 | `(uzupełnić)` | `Code.gs`, `IA4_INSTRUKCJA.md` + wersje | Wersja 0.23: `patchGapsIfIdle_` odświeża arkusz PROJEKT po każdej zmianie statusu luki (trzeci przypadek L12); `VOLFILL_DAILY_WRITES` 3000→10000, `VOLFILL_MIN_GAP_MIN` 7→3 — koniec potrzeby ostrożności po zamknięciu 0.6, reszta historii dogoni się w 3–4 dni. |
